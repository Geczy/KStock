...
class TimeThread(QtCore.QThread):
    #Threaded Timer, allows for background updates every 5 seconds
...
class StreamThread(QtCore.QThread):
    #Threaded Streamer, allows for background updates every 1 hour
    #Ensures that the Suggestion Table is moderately up to date
    update = QtCore.pyqtSignal()
